...
import { registerUser } from "../repositories/menurepositories"; // Ensure this function is defined in your menurepositories
...
export default function useSignupUser() {
  ...
  const signup = async (username, email, password) => {
    ...
    try {
      const data = await registerUser(username, email, password); // Call the signup function from menurepositories
